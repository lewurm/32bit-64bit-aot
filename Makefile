...
all: System.dll-llvm.o.asm
	grep -A 20 'System_Mono_AppleTls_AppleTlsContext_ProcessHandshake' $<
...
%-llvm.o: %
	MONO_PATH=3-Build $(AOT_COMPILER) \
		...
		--aot=mtriple=armv7-ios,static,asmonly,direct-icalls,full,nodebug,dwarfdebug,direct-pinvoke,llvm-path=$(LLVM_PATH),outfile=$<.s,llvm-outfile=$<-llvm.o 3-Build/$<
